...
RegisterNUICallback('showBlur', function()
    Wait(50)
    TriggerEvent("0x-inventory:client:showBlur")
end) 
RegisterNetEvent("0x-inventory:client:showBlur", function()
    Wait(50)
...
RegisterNetEvent("0x-inventory:client:closeinv", function()
    closeInventory()
end)
...
RegisterNetEvent('0x-inventory:client:giveAnim', function()
