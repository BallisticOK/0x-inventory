...
lj-Inventory has been fully redesigned by [OK1ez](https://github.com/OK1ez), under the name 0x-inventory.

Future updates will be coming and we will of course support all normal monitor sizes.

# Previews

### Simple item guidelines (found in main directory 0x-inventory)

![0x-inventory Guideline](https://user-images.githubusercontent.com/91661118/146315681-c67f542d-e2bc-43ca-9957-7f1971b84268.png)
...
* Easy Photoshop guideline template for creating custom images within 0x-inventory
...
# How to install 0x-inventory (Latest QBCore Update)

* Download `0x-inventory` from our GitHub
...
* Drag `0x-inventory` into your resources folder or any subfolder
* Make sure that the folder is named `0x-inventory` and **not** `0x-inventory-main`
* Replace all occurrences of `qb-inventory` with `0x-inventory`.<br>The example below uses Visual Studio Code to replace all instances.

![image](https://github.com/Z3rio/0x-inventory/assets/54480523/00fa21a5-4be2-443f-aff2-4b3202b662dc)
